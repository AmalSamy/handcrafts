...
class RolePolicy
{
    ...
    {
        return $user->hasAability('roles.index');
    }
    ...
    {
        return $user->hasAability('roles.update');
    ...
    {
        return $user->hasAability('roles.delete');
    ...
    {
        return $user->hasAability('roles.restore');
    ...
    {
        return $user->hasAability('roles.forceDelete');
